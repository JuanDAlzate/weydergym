							...
							<div class="12u 12u(narrower) important(narrower)">
									...
									<?php 
										...
										$registros=$conexion->fetcAll(PDO::FETCH_OBJ);*/
											echo "<h2 class='title'>Mensualidades creadas</h2>";
											$mensualidad=$base->query("SELECT cod_mensualidad,identificacion,nombre,apellido,fecha_pago,fecha_caducidad,valor FROM mensualidad INNER JOIN personas ON mensualidad.id_persona=personas.identificacion")->fetchAll(PDO::FETCH_OBJ);
									...
									<table class="table-rwd">
										...
										<tr>
											...
											<td ><a href="eliminarMensualidad.php?cod=<?php echo $men->cod_mensualidad ?>"><input type="button" class="botones" name="del" id="del" value="Borrar"></a></td>

											<td><a href="editarMensualidad.php?cod=<?php echo $men->cod_mensualidad?> & fechaP=<?php echo $men->fecha_pago?> & fechaV=<?php echo $men->fecha_caducidad?> & val=<?php echo $men->valor?> & ven=<?php echo $men->vencida ?> & idP=<?php echo $men->id_persona ?> "><input type="button" class="botones" name="up" id="up" value="Actualizar"></a></td>
										</tr>
											<?php 
												endforeach;
											 ?>
										<tr class="fila-create">
											<td><input type="text" class="camp-c" name="cod_men" disabled></td>
											...
											<td class="bot" colspan="1">
												<input type="submit" name="btn-insertar " class="botones boton-grande" value="Crear">
											</td>
										</tr>
									</table>
